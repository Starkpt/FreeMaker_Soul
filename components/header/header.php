...
$adm = $_SESSION['adm'] ?? null; // Avoids error suppression with `@`
$title = htmlspecialchars($title); // Escape title to prevent XSS
...
<body>
    ...
    <header class="header">
        <div class="wrapper">
            ...
            <nav class="menu">
                <a href="index.php" class="link" title="Página principal">Home</a>
                <a href="/produtos/products" class="link" title="Todos os produtos">Produtos</a>
                <li class="categorias link" tabindex="0">
                    <a href="#">Categorias</a>
                    <ul class="submenu">
                        <?php foreach (['Figuras', 'Decor', 'Gaming', 'Misc', 'Porta-Chaves', 'Utensílios'] as $categoria): ?>
                            <li><a class="link" href="products.php?categoria=<?= urlencode($categoria) ?>"><?= $categoria ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </li>
            </nav>
                ...
                <?php if ($_SESSION): ?>
                    <div class="profile_container">
                        ...
                        <ul class="profile-options">
                            <?php if ($adm): ?>
                                <li><a href="adm_configs.php">Configurar</a></li>
                            <?php else: ?>
